...
var PathConfig = require('./grunt-settings.js');
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      html: {
        files: ['./templates/**/*.html', './layout/**/*.html', './views/**/*.html'],
        tasks: ['htmlbuild'],
        options: {
            spawn: false
        }
        ...
        options: {
          ...
          sections: {
            ...
            views: {
              ...
              product: './views/product.list.html',
              product_list: './views/product.html',
              breadcrumbs: './views/breadcrumbs.html',
              filter: './views/filter.html',
              sort: './views/sort.html',
...
//finally 
  ...
  //final build
  grunt.registerTask('dist', ['clean:temp', 'imgmin', 'cssbeauty', 'htmlbuild']);
